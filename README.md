...
## FAQ
 ...
 1. __The DB storage system crashes, what to do?:__
       ...
       _mac os_:<br>      
		`sudo launchctl unload -w /System/Library/LaunchDaemons/couchdb.plist <br> sudo launchctl load -w /System/Library/LaunchDaemons/couchdb.plist`
       ...
       _mac os_:<br>
		`sudo launchctl unload -w /System/Library/LaunchDaemons/monetdb5-sql.plist <br> sudo launchctl load -w /System/Library/LaunchDaemons/monetdb5-sql.plist`

...
|Q20| SELECT ?indDish ?belDish ?ingredient  WHERE {<br>(tp1): ?indDish a dbpedia-owl:Food . <br>(tp2): ?indDish dbpedia-owl:origin<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; dbpedia:India . <br>(tp3): ?indDish dbpedia-owl:ingredient <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;?ingredient . <br>(tp4): ?belDish a dbpedia-owl:Food . <br>(tp5): ?belDish dbpedia-owl:origin <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; dbpedia:Belgium . <br> (tp6): ?belDish <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dbpedia-owl:ingredient ?ingredient . <br>}  | BGP_1{ <br>(tp1_or_4): ?s1 rdf:type dbpedia-owl:Food  (tp1_or_4'_a): ?s1 rdf:type dbpedia-owl:Food <br> (tp2): ?s2 dbpedia-owl:origin dbpedia:India (tp2'_a): ?s4 dbpedia-owl:origin dbpedia:India <br>(tp1_or_4'_b): ?s4 rdf:type dbpedia-owl:Food <br>(tp2'_b): ?s5 dbpedia-owl:orgin dbpedia:India <br>(tp3): ?s1 dbpedia-owl:ingredient ?o7 <br>(tp1_or_4'_c): ?s5 rdf:type dbpedia-owl:Food <br>(tp3_or_6'_a): ?s8 dbpedia-owl:ingredient ?o7 <br> (tp5'_a): ?o7 dbpedia-owl:origin dbpedia:Belgium <br>(tp6): ?s1 dbpedia-owl:ingredient ?o7<br>(tp3_or_6'_b): ?s1 dbpedia-owl:ingredient ?o7<br>(tp5): ?s2 dbpedia-owl:ingredient dbpedia:Belgium<br>(tp3_or_6_c): ?s6 dbpedia-owl:ingredient ?o14<br>(tp2_f): ?s8 dbpedia-owl:origin dbpedia:Belgium<br>(tp3_or_6_c): ?s8 dbpedia-owl:ingredient ?s2 <br>}<br><br> BGP_2{<br>   (tp3_or_6_d): ?s1  dbpedia-owl:ingredient  ?o1  <br> (tp1_or_4_d):  ?s1  rdf:type  dbpedia-owl:Food <br> (tp3_or_6_e): ?s3  dbpedia-owl:ingredient ?s1 <br> (tp2'_c):  dbpedia-owl:origin     dbpedia:India <br> (tp1_or_4_d): ?s1    rdf:type dbpedia-owl:Food ?o5 <br>} |  1 | 0,24 |

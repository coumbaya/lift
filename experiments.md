...
|Q13| SELECT ?actor ?cause WHERE {<br>(tp1): ?actor dbpedia-owl:deathCause<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ?cause . <br> (tp2): ?actor dc:subject<br>&nbsp;&nbsp;&nbsp;dbpedia-cat:American_male_film_actors <br>} |  BGP_1{<br>(tp2_equiv):    ?s1  rdf:type<br>&nbsp;&nbsp;&nbsp;&nbsp;dbpclass:PeopleExecutedByCrucifixion  (tp1_equiv):   ?s1  rdf:type<br>&nbsp;&nbsp;&nbsp;&nbsp; dbpclass:Carpenters <br>}<br>BGP_2{ <br (tp2'_a):    ?s1   rdf:type     dbpclass:Carpenters <br>(tp1'_a):   ?s1    rdf:type   dbpclass:Carpenters<br>}   | 1 | 0,5 |
